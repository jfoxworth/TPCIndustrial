	...
	<div id="wrapper" class="clearfix">
		...
		<section id="content">
			...
			<div class="content-wrap">
				...
				@include('layouts.Landing.popIcons')

				@include('layouts.Landing.parts')

				@include('layouts.Landing.iconlist')

				@include('layouts.Landing.clientList')

				@include('layouts.Landing.testimony')
